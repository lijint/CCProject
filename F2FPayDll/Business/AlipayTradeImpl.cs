...
namespace Com.Alipay
{
    ...
    public class AlipayTradeImpl : IAlipayTradeService
    {
     ...
     string sign_type, string alipay_public_key, string charset)
        ...
        public AlipayTradeCancelResponse tradeCancelResponse(string outTradeNo)
        {
            AlipayTradeCancelResponse tr = new AlipayTradeCancelResponse();
            try
            {
                tr = tradeCancel(outTradeNo);
